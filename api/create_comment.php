            ...
            if( mysqli_num_rows($result_user) > 0 ){
                ...
                if($row_user['is_deleted'] == 1){
                    ...
                    if($row_user['status'] == 0){
                        ...
                        $create_comment = "INSERT INTO post_comments (user_id,post_id,comment,status) VALUES ('$user_id','$post_id','$comment',1)";
                        $result_create_comment = mysqli_query($conn,$create_comment);
                        
                        if($result_create_comment){
                            
                            $response["error"] = FALSE;
                            $response["success_msg"] = "Comment Created Successfully!";
                            ...
                            $statement = $user_nam." commented on your post";
