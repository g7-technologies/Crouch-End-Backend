...
if(isset($_POST['create_role'])){
    ...
    $query = "INSERT INTO role (name) VALUES ('$role_type')";
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="role_type" required="required" placeholder="Role" id="example-text-input"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <button class="btn btn-outline-success waves-effect waves-light" name="create_role" style="width: 100%">Create Role</button>
                                                    </div>
                                                    <div class="col-sm-3">
